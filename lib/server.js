    ...
    middleware: function(options) {
        ...
        return function(req, res, next) {
            ...
            server.get(req.path, function(err, result) {
                ...
                if (options.view) {
                    if (options.renderOptions && typeof options.renderOptions === 'function'){                         
                         res.render(options.view, options.renderOptions(result))
                    } else if (options.preParse && options.preParse === true) {
